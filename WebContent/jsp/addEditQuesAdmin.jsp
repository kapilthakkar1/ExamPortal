...
function goToViewQuestions(examId,examName)
{
	document.getElementById('examId').value=examId;
	document.getElementById('examName').value=examName;
	document.getElementById('actionName').value="viewQuestions";
	document.getElementById('classId').value="13";
	document.forms[0].action="main";
	document.forms[0].method = "post";
	document.forms[0].submit();
...
<ul id="page">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<a class="btn btn-primary" href="#" onclick="goToViewQuestions('<%=examDtls.getExamId()%>','<%=examDtls.getExamName()%>');">View/Edit Questions <span
					class="glyphicon glyphicon-chevron-right"></span></a> 
			</div>
			<dir class="col-md-1"></dir>
		</div>
